...
<Details summary="type" tags={["Optional"]}>
...
<Details summary="magicSdkConfiguration" tags={["Optional"]}>
...
<Details summary="locale" tags={['Optional']}>
...
<Details summary="endpoint" tags={['Optional']}>

A URL pointing to the Magic iframe application.

</Details>

<Details summary="testMode" tags={['Optional']}>
...
<Details summary="smsLogin" tags={['Optional']}>
...
<Details summary="emailLogin" tags={['Optional']}>
...
<Details summary="oauthOptions" tags={['Optional']}>
...
<Callout variant="warning" title="URL">
...
<Details summary="oauthProvider" tags={["Optional"]}>
