...
import QRModalOptionsMDX from "./qrModalOptions.mdx";
...
A wallet configurator for [Wallet Connect](/wallets/wallet-connect) which allows integrating the wallet with React
...
<Details summary="qrModalOptions">
	<QRModalOptionsMDX />
</Details>
