...
If the chain you are looking for is not one of default supported chains, you can import a chain from the [@thirdweb-dev/chains](https://github.com/thirdweb-dev/js/tree/main/packages/chains) package which has 1000+ chains.
