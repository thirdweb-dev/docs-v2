...
We recommend using npx to get latest version. Alternatively, you can install the CLI as a global command on your maching

<InstallTabs npm i -g @thirdweb-dev/cli/>
