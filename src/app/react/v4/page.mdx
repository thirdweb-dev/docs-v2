...
A collection of [100+ React hooks](/references/react/v4#hooks) and UI components for your web3 apps, for <i>any</i> EVM-compatible blockchain.
...
<OpenSourceCard
	title="React SDK"
	href="https://github.com/thirdweb-dev/js/tree/main/packages/react"
/>
...
<div className="flex gap-3">
	...
	[Templates](https://thirdweb.com/templates) • [GitHub](https://github.com/thirdweb-dev/js)
</div>
