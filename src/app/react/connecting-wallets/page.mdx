...
[`ConnectWallet`](/react/react.connectwallet) component renders a button which when clicked opens a modal to allow users to connect to wallets specified in the [ThirdwebProvider's supportedWallets](/react/ThirdwebProvider#supportedWallets) prop.
