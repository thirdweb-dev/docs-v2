...
import OverridesMDX from "./props/overrides.mdx";
...
1. There is a **connected wallet**
   (if there is not, it renders a [ConnectWallet Button](/react/components/ConnectWallet) instead).
2. The connected wallet is on the **correct network**
   as specified in the [ThirdwebProvider](/react/ThirdwebProvider#activeChain)'s
...
<Details id="overrides" summary="overrides">
	<OverridesMDX />
</Details>
