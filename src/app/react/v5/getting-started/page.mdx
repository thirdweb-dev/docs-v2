...
You can also build your own custom button using the [`useConnect`](/react/v5/useConnect) hook.
...
Using [Extensions](/react/v5/extensions) you can do more complex transactions like a claim, batch mint, and more. These will handle all the preprocessing needed before calling the contract.
