...
Take [in-app wallet](https://github.com/thirdweb-dev/js/blob/main/packages/react/src/wallet/wallets/embeddedWallet/embeddedWallet.tsx) for example, It renders an Social Icons + Email Input.

<Callout variant='info'>

In this example, rest of the wallets are put behind a "Connect a wallet" button - that is NOT because the inAppWallet wallet has a custom `selectUI` but because the inAppWallet is a social login.
...
Take [in-app wallet](https://github.com/thirdweb-dev/js/blob/main/packages/react/src/wallet/wallets/embeddedWallet/embeddedWallet.tsx) for example, It renders Social Icons + Email Input.
...
- [In-App wallet](https://github.com/thirdweb-dev/js/blob/main/packages/react/src/wallet/wallets/embedded-wallet.tsx)
