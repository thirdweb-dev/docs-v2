import { InstallTabs, SDKCard, Grid } from "@/components/Document";
...
thirdweb's React, React Native, and Unity SDKs uses this package internally and offers a higher level abstraction for connecting these wallets. Refer to the documetation below to see how to connect wallets in these SDKs
