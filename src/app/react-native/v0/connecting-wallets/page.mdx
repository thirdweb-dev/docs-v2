...
- [Coinbase Wallet](/react-native/v0/wallets/coinbase)
...
- create an instance of your wallet using [useCreateWalletInstance](/references/react-native/v0/useCreateWalletInstance)
- connect your wallet using the `connect` method of the wallet
- once the wallet is connected, set the wallet instance as connected using [useSetConnectedWallet](/references/react-native/v0/useSetConnectedWallet)

Make sure to update the `connectionStatus` using [useSetConnectionStatus](/references/react-native/v0/useSetConnectionStatus) to `"connecting"` before connecting your wallet and `"disconnected"` if the connection fails.
