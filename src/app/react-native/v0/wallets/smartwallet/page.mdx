...
You can see the list of available wallet configurators for React Native [here](/react-native/v4/connecting-wallets).
...
To allow users to connect to this wallet using the [ConnectWallet](/references/react-native/v4/ConnectWallet) component, you can add it to [ThirdwebProvider's supportedWallets](/react-native/v4/connecting-wallets#supported-wallets) prop.
...
you can use the [`useSmartWallet`](/references/react-native/v4/useSmartWallet) hook to programmatically connect to the smart wallet without using the [ConnectWallet](/references/react-native/v4/ConnectWallet) component.

`smartWallet()` also needs to be added in [ThirdwebProvider's supportedWallets](/react-native/v4/connecting-wallets#supported-wallets) if you want the wallet to auto-connect on next page load.
