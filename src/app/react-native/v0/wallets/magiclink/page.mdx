...
This wallet is deprecated. Please use [Embedded Wallet](/react-native/v4/wallets/wallets/embedded-wallet/overview) instead for adding Social Login to your app.
