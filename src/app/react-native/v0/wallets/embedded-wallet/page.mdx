...
<WalletsBreadcrumb name="In-App Wallet" slug="embedded-wallet" />

# EmbeddedWallet

A wallet configurator for [In-App Wallet](/connect/embedded-wallet/overview) which allows integrating the wallet with React Native
...
The hook will return all the necessary functions you'll need to authenticate and connect to the in-app wallet.
