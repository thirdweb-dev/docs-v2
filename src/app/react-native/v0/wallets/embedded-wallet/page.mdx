...
You can use the [`useEmbeddedWallet`](/references/react-native/useEmbeddedWallet) hook to programmatically connect to the wallet without using the [ConnectWallet](/react-native/connecting-wallets#connect-wallet) component.
