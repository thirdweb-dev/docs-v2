...
you need to first obtain an API key from the [dashboard](https://thirdweb.com/dashboard) and then copy the "Client ID" and pass it to the `ThirdwebProvider` as the `clientId` prop.
