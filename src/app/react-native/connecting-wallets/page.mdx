...
| --------------- | --------------------------------------- |
| MetaMask        | [metamaskWallet](/react/metamaskWallet) |
| Coinbase Wallet | [coinbaseWallet](/react/coinbasewallet) |
| Wallet Connect  | [walletConnect](/react/walletconnect)   |
| Embedded Wallet | [embeddedWallet](/react/embeddedwallet) |
| Local Wallet    | [localWallet](/react/localwallet)       |
| Smart Wallet    | [smartWallet](/react/smartwallet)       |
| Magic Link      | [magicLink](/react/magiclink)           |
| Rainbow Wallet  | [rainbowWallet](/react/rainbowWallet)   |
...
| Hook                                                                | Description                            |
| ------------------------------------------------------------------- | -------------------------------------- |
| [useAddress](/references/react-native/useAddress)                   | get connected wallet's account address |
| [useDisconnect](/references/react-native/useDisconnect)             | disconnect the connected wallet        |
| [useWallet](/references/react-native/useWallet)                     | get connected wallet instance          |
| [useWalletConfig](/references/react-native/useWalletConfig)         | get connected wallet's config          |
| [useConnectionStatus](/references/react-native/useConnectionStatus) | get status of wallet connection        |
