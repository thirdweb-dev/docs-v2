...
import { CodeBlock, InlineCode } from "@/components/Document";
...
<Tabs defaultValue="cli_project">
    	...
    	<TabsContent value="cli_project">
    		<InstallTabs
    			...
    			npm="npm i 'ethers@^5' @thirdweb-dev/react-native @thirdweb-dev/react-native-compat node-libs-browser react-native-crypto react-native-randombytes react-native-get-random-values react-native-svg react-native-mmkv @react-native-async-storage/async-storage"
    			yarn="yarn add 'ethers@^5' @thirdweb-dev/react-native @thirdweb-dev/react-native-compat node-libs-browser react-native-crypto react-native-randombytes react-native-get-random-values react-native-svg react-native-mmkv @react-native-async-storage/async-storage"
    			pnpm="pnpm i 'ethers@^5' @thirdweb-dev/react-native @thirdweb-dev/react-native-compat node-libs-browser react-native-crypto react-native-randombytes react-native-get-random-values react-native-svg react-native-mmkv @react-native-async-storage/async-storage"
    		/>
    	...
    	<CodeBlock
    		lang={'bash'}
    		code={`npx install-expo-modules@latest`}/>
...
<CodeBlock lang={"bash"} code={`npx install-expo-modules@latest`} />
...
<TabsContent value="tw_cli">
	<CodeBlock
		lang={"bash"}
		code={"npx thirdweb create --template react-native-typescript-starter"}
	/>
</TabsContent>
...
Note that running through <b>Expo Go</b> app currently isn't supported. You
 ...
 <CodeBlock lang={"bash"} code={"npx thirdweb create --template react-native-expo-starter"} />
</TabsContent>
...
Alternatively you can use the React Native CLI. Note that you need to follow
 ...
 <CodeBlock lang={"bash"} code={"npx react-native init MyRNApp --template react-native-template-typescript"} />
</TabsContent>
...
Alternatively you can use the Expo CLI. Note that you need to follow the
 ...
 <CodeBlock lang={"bash"} code={"npx create-expo-app AwesomeProject"} />
</TabsContent>
