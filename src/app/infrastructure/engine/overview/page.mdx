...
import { ArticleCard, Grid, OpenSourceCard } from "@doc";
...
<ArticleCard
	title="Cloud-host for $99/month"
	description="Host Engine on thirdweb with no setup or maintenance."
	href="https://share.hsforms.com/1k5tu00ueS5OYMaxHK6De-gea58c"
/>

<ArticleCard
	title="Self-host for free"
	description="Host Engine on your own infrastructure with minimal setup."
	href="/infrastructure/engine/get-started"
/>
