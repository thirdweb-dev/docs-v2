...
A [local wallet](/wallet/local-wallet) is a wallet created or imported from a private key. Ensure your private key is backed up before transacting with a local wallet in a production environment.
...
An [AWS KMS Wallet](/wallet/aws-kms) is a wallet securely stored in your AWS account.
