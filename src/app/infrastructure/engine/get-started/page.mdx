...
Consider the [TypeScript SDK](/infrastructure/engine/references/typescript-sdk) for type-safety.
...
Trigger an action when transactions complete by configuring [webhooks](/infrastructure/engine/webhooks) to call your backend server.
