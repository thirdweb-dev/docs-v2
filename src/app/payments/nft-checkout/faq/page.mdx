...
Buyers who don't have a wallet can create one with their email or social login. This uses thirdweb's non-custodial [Embedded Wallet](/wallets/embedded-wallet/overview) product.
