...
Yes! You'll need to "wrap" your NFT with a marketplace contract like [thirdweb marketplace](/pre-built-contracts/marketplace) or build your own. This "direct listing" approach works like this:
...
Buyers who don't have a wallet can create one with their email or social login. This uses thirdweb's non-custodial [Embedded Wallet](/embedded-wallet) product.
