...
- You have the user's wallet address
  - If you do not already a wallet set up for your users, use [Connect](/wallets/connect/connect-get-started) to create a wallet first.
...
Embed [CheckoutWithCard](/payments/checkout-with-card) in your app.

#### Accepting crypto payment options (ETH)

Embed [CheckoutWithEth](/payments/checkout-with-eth) in your app.
