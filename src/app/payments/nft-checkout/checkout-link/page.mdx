...
// import createCheckoutLinkImage from "../assets/create-new-checkout-link.jpg"; // Missing Image
...
1. Navigate into your contract from the [Contracts > Deploy dashboard page](https://thirdweb.com/dashboard/contracts/contracts/deploy/overview).
2. Navigate to the "Payments" page from the sidebar.
3. Click the "Create New Checkout" button
   {/* <DocImage src={createCheckoutLinkImage} /> */}
