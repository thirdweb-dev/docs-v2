...
<DocImage src={require("../assets/preview.png")} alt="Gaming Diagram preview" />
...
- **Customizable:** Control all aspects of the user experience. For example, you can our tools to bring your own authentication system and spin up in-game embedded wallets for users.
