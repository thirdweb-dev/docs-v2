...
Use the `AccountFactory` contract alongside the [`SmartWallet`](/wallet/smart-wallet) connector or [`ConnectWallet`](/react/latest/components/ConnectWallet) to easily use account abstraction in your projects:
