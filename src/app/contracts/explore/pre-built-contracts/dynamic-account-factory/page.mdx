...
Use the `DynamicAccountFactory` contract alongside the [`SmartWallet`](/connect/smart-wallet) connector or [`ConnectWallet`](/react/latest/components/ConnectWallet) to easily use account abstraction in your projects:
