...
<Image src={require("./assets/pack-diagram-1.png")} alt="Pack diagram 1" />
...
<Image src={require("./assets/pack-diagram-2.png")} alt="Pack diagram 2" />
...
- **Using an oracle (e.g. Chainlink VRF)**
  ...
  <Image src={require("./assets/pack-diagram-3.png")} alt="Pack diagram 3" />
