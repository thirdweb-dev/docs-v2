...
export const metadata = createMetadata({
	...
	title: "Signature minting design document | thirdweb",
	description:
		"This is a live document that explains what the thirdweb Signature minting smart contract is, how it works and can be used, and why it is designed the way it is",
});
