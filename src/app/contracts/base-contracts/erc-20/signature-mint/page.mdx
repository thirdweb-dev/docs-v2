...
functionality to the [ERC20Base](/solidity/base-contracts/erc20base) contract. [Signature minting](/glossary/signature-based-minting) uses [EIP-712](https://eips.ethereum.org/EIPS/eip-712),
...
```
  ...
  <GithubButtonLink
    href="https://github.com/thirdweb-dev/contracts/blob/main/contracts/base/ERC20SignatureMint.sol"
  />
