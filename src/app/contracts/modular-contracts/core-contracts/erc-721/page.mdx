...
|----------------------|------------|-----------|
| `beforeMintERC721`   | `0xa0e67e2b`| REQUIRED  |
| `beforeTransferERC721`| `0xe7dc220b`| OPTIONAL  |
| `beforeBurnERC721`   | `0xddf252ad`| OPTIONAL  |
| `beforeApproveERC721`| `0x7b7f702b`| OPTIONAL  |
| `beforeApproveForAll`| `0x48b84b11`| OPTIONAL  |
