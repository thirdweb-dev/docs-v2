...
The `ERC20Drop` base contract adds the [Drop Single Phase](/contracts/build/extensions/general/DropSinglePhase) extension to the [ERC20 base](/solidity/base-contracts/erc20base) contract
