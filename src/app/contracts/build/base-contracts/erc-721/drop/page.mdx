...
It implements the [ERC721A standard](/solidity/erc721) with the [Lazy Mint](/contracts/build/extensions/general/LazyMint),
[Delayed Reveal](/solidity/extensions/delayedreveal) and [Drop](/contracts/build/extensions/general/DropSinglePhase) extensions;
