...
implementing [`ERC721`](/contracts/build/extensions/erc-721/ERC721) and [`ERC721Claimable`](/solidity/extensions/erc721claimable) extensions.

This is an extension which is detectable in the dashboard if the smart contract implements the
[`ERC721`](/contracts/build/extensions/erc-721/ERC721) and [`ERC721Claimable`](/solidity/extensions/erc721claimable) extensions.
