...
Enable minting multiple NFTs at once in a single transaction by Implementing [`ERC721`](/contracts/build/extensions/erc-721/ERC721), [`IMintableERC721`](/contracts/build/extensions/erc-721/ERC721Mintable), and [`Multicall`](/solidity/extensions/multicall) extensions.

This is an extension which is detectable in the dashboard if the smart contract implements the
[ERC721](/contracts/build/extensions/erc-721/ERC721), [Multicall](/solidity/extensions/multicall) and [ERC721Mintable](/contracts/build/extensions/erc-721/ERC721Mintable) extensions.
