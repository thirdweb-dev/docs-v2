...
| -------------------------------------------------------------------------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSignMintRequest`](/contracts/build/extensions/erc-721/ERC721SignatureMint) | internal view _virtual_ | Runs on every attempt to mint tokens with signature on the contract. Returns whether the signer is authorized to issue a signature for minting. |
| [`mintWithSignature`](/contracts/build/extensions/erc-721/ERC721SignatureMint)   | external payable        | Mints tokens according to the provided mint request.                                                                                            |
