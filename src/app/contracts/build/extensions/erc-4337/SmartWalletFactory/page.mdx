...
The `BaseAccountFactory` smart contract is an extension usable with the [Dynamic](/contracts/build/base-contracts/erc-4337/dynamic-account), [Managed](/contracts/build/base-contracts/erc-4337/managed-account) and [Non-Upgradable](/solidity/base-contracts/non-upgradable-account) Account smart contracts.
