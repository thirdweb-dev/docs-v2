...
Enable minting multiple NFTs at once in a single transaction by Implementing [`ERC20`](/solidity/extensions/erc20), [`IMintableERC20`](/contracts/build/extensions/erc-20/ERC20BatchMintable), and [`Multicall`](/solidity/extensions/multicall) extensions.

This is an extension which is detectable in the dashboard if the smart contract implements the
[`ERC20`](/solidity/extensions/erc20), [`Multicall`](/solidity/extensions/multicall) and [`ERC20Mintable`](/contracts/build/extensions/erc-20/ERC20BatchMintable) extensions.
