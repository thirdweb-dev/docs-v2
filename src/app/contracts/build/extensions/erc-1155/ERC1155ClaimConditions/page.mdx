...
implementing [`ERC1155`](/contracts/build/extensions/erc-1155/ERC1155) and [`DropSinglePhase`](/solidity/extensions/dropsinglephase) extensions.

This is an extension which is detectable in the dashboard if the smart contract implements the
[`ERC1155`](/contracts/build/extensions/erc-1155/ERC1155) and [`ERC1155DropSinglePhase`](/solidity/extensions/erc1155dropsinglephase) extensions.
