...
Enable minting multiple NFTs at once in a single transaction by Implementing [`ERC1155`](/contracts/build/extensions/erc-1155/ERC1155), [`IMintableERC1155`](/solidity/extensions/erc1155mintable), and [`Multicall`](/solidity/extensions/multicall) extensions.

This is an extension which is detectable in the dashboard if the smart contract implements the
[`ERC1155`](/contracts/build/extensions/erc-1155/ERC1155), [`Multicall`](/solidity/extensions/multicall) and [`ERC1155Mintable`](/solidity/extensions/erc1155mintable) extensions.
