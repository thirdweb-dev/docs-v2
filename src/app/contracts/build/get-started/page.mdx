...
All functions in the [base contracts](/contracts/build/base-contracts) and [extensions](/contracts/build/extensions) can be modified by [overriding them](/solidity/getting-started#inheritance-and-overriding-functions).
...
**3.** Now you're all set up! 🎉 Your smart contract now has all the [extensions](/contracts/build/extensions) provided by the [base contract](/solidity/base-contracts/) it inherits and is ready to be [deployed](/deploy) to any EVM blockchain of your choice.
