...
**3.** Now you're all set up! 🎉 Your smart contract now has all the [extensions](/contracts/build/extensions) provided by the [base contract](/solidity/base-contracts/) it inherits and is ready to be [deployed](/contracts/deploy/overview) to any EVM blockchain of your choice.
