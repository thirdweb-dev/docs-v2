...
- `WalletProvider.WalletConnectV1`: [WalletConnect](/unity/wallets/providers/walletconnect)
- `WalletProvider.LocalWallet`: [Local Wallet](/unity/wallets/providers/localwallet)
- `WalletProvider.SmartWallet`: [Smart Wallet](/unity/wallets/providers/smartwallet)
...
Admin signer to use with [Smart Wallet](/unity/wallets/providers/smart-wallet) as your main provider.
