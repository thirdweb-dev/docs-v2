...
- `WalletProvider.InAppWallet`: [In-App Wallet](/unity/wallets/providers/embeddedwallet)
...
Optional email for default [In-App Wallet](/unity/wallets/providers/embeddedwallet) email flow.
...
[In-App Wallet](/unity/wallets/providers/embeddedwallet) Authentication Options.
