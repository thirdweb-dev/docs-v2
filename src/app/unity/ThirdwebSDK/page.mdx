...
<Details summary="View default chains">
	<ul>
		<li>
...
To use the Unity SDK, you need to pass a `clientId` option which you can obtain from an API key from the [Dashboard](https://thirdweb.com/create-api-key).
