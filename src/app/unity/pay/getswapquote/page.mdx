...
export const metadata = createMetadata({
	title: "GetSwapQuote | thirdweb Unity SDK",
	description:
...
public async void GetQuote()
{
	...
	SwapQuoteResult quote = await ThirdwebPay.GetSwapQuote(swapQuoteParams);
...
A SwapQuoteParams object (with a helpful constructor) containing the following properties:
...
A SwapQuoteResult object containing the following properties:
...
string fromAddress; // Address executing the swap
string toAddress; // Address to receive the to token
