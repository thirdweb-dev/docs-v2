...
This smart account is unlocked by a 'key' - a personal account. This key can be anything from a [MetaMask](/references/wallets/v2/MetaMaskWallet) wallet or even a [Embedded Wallet](../connect/embedded-wallet) and is used as a way to 'sign in' to the wallet.
