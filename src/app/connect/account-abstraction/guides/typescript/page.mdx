...
To use smart accounts in a node script, we are going to set up our project using the CLI [create](/cli/create) command.
...
To follow this specific example, you will need the following setup:
