...
import { embeddedWallet, smartWallet } from "thirdweb/react";
import { sepolia } from "thirdweb/chains";
...
To claim an NFT, we will use the the [TransactionButton](/references/typescript/v5/TransactionButton) component to send the transaction.
