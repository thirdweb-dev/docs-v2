...
By combining [Account abstraction](/connect/account-abstraction) and [In-App Wallet](/connect/embedded-wallet/overview), you can create a truly seamless user experience:
