...
For example, if a user purchases $100 worth of Polygon through your application, thirdweb collects $0.70 from our base fee and sends $0.30 to your configured recipient address.
