...
thirdweb collects a 1% fee and 30¢ per end user transaction. We share 30% of our fee with you.

For example, if a user purchases $100 worth of Polygon through your application, we collect $0.70 and send $0.30 to your configured recipient address.
