...
<Callout variant="info" title="Try PayEmbed">
	`PayEmbed` component handles the complexity of the process detailed below and
	can be integrated in minutes. We encourage you to check out the [PayEmbed
	guide here](/connect/pay/get-started/PayEmbed).
</Callout>
