...
In this guide, we’ll walk you through getting a quote and sending a transaction with our Typescript SDK. Once set up, your app will be able to provide crypto purchases for users.
...
function GetQuote(buyWithCryptoParams) {
