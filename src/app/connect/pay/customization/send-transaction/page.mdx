...
# sendTransaction Customization

Learn how to customize the Pay interface when executing a transaction with `sendTransaction`. You can find a selection of popular customizations below. For the full list of props, you can [view the full reference](/references/typescript/v5/SendTransactionConfig).
