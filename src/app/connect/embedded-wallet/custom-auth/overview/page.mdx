...
export const metadata = createMetadata({
	...
	title: "Custom Authentication | thirdweb Embedded Wallet",
	description:
		"Embedded wallets already support most popular login methods out of the box, but we also give app developers the flexibility to use embedded wallets with any authentication method",
});

# Overview

Embedded wallets already support the most popular login methods out of the box, but we also give app developers the flexibility to use
