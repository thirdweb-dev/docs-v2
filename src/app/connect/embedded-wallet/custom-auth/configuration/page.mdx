...
It is good for supporting other auth method that we don't support today too, like discord, twitter, github etc., or something completely custom.
...
- `payload`: This will correspond to the public identifier that was generated for your user.
