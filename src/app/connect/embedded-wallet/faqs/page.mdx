...
### Does the Embedded Wallet product use smart contract wallets?

The embedded wallet can be used as a signer to a smart contract account (account abstraction), but it can also be used as a standalone EOA.
