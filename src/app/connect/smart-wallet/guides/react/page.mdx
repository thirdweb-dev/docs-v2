...
C thirdweb offers the following three different kinds of account factories:
...
Read about the differences between the three account factory types [here](/smart-wallet/how-it-works).
...
To add a session key to your smart account, you can use the [`useCreateSessionKey`](/references/react/v4/useCreateSessionKey) hook to add a session key to the currently connected smart account:
