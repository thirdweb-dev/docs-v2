...
### How do I sign transactions with my smart account?
...
Embedded Wallets with account abstraction is a powerful combination that allows users to sign in using their email, social media accounts, or custom JWT method (Embedded Wallet), and provides a completely gasless user experience.

### Are smart accountscustodial or non-custodial?
