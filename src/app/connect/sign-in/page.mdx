...
| OPTION               | BEST FOR                                                   |
|----------------------|------------------------------------------------------------|
| ConnectButton        | Developers who want an easy-to-integrate button with modal.|
| ConnectEmbed         | Developers who want an easy-to-integrate full sign-in page experience.|
| Custom UI (useConnect)| Developers who want complete customization over the modal branding.|
