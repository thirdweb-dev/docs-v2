...
In your project's components directory, create a `ConnectButton.tsx` file:
...
import { generatePayload, isLoggedIn, login, logout } from "@/actions/auth"; // we'll create this file in the next section
