...
export const metadata = createMetadata({
	...
	title: "Sign-in with Wallet | thirdweb",
	description:
		"Allow the user to use their wallet as their identity to login into our application",
});
...
| `chainId`        | string                                                          | (optional) The chainId that the user is signing-in with. This field is required in order to sign-in with smart contract wallets ([EIP1271](https://eips.ethereum.org/EIPS/eip-1271)). |
