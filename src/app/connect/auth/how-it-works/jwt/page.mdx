...
import jsonWebTokensImage from "../../assets/json-web-tokens-1.png";
...
export const metadata = createMetadata({
	...
	title: "JSON Web Tokens | thirdweb",
	description:
...
```json
{
	...
	"iat": 1653884584, // Unix time (epoch seconds) when the payload was issued
...
<DocImage src={jsonWebTokensImage} />

As you can see, the correct header and body data are picked up from our JWT and rendered on the right side of the screen!
