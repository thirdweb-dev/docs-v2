...
export const metadata = createMetadata({
	...
	title: "Auth in thirdweb React SDK",
	description: "Add support for Auth to your React apps",
});
...
Once you've set up an Auth API for your application, you can use the `@thirdweb-dev/react` and `@thirdweb-dev/auth` packages to add Auth support to your React apps.
...
For a full list of wallet connection hooks, check out our [React SDK documentation](/react/latest).
