import { createMetadata, V4Callout } from "@doc";
...
export const metadata = createMetadata({
	...
	title: "Auth in thirdweb React Native SDK",
	description: "Add support for Auth to your React Native apps",
});
...
Once you've set up an Auth API for your application, you can add Auth support to your React Native apps.

## Getting Started

To add support for Auth to your React Native apps, you'll first need to set up your [React Native app](/react-native/latest).
...
For a full list of wallet connection hooks, check out our [React Native SDK documentation](/references/react-native/v0/hooks#wallet-connection).
