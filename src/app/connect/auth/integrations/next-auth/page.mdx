...
export const metadata = createMetadata({
	...
	title: "Next Auth | thirdweb",
	description:
		"how to integrate Auth with NextAuth to let your users login with their wallets",
});
...
<OpenSourceCard
	title="thirdweb-auth-next-auth"
	href="https://github.com/thirdweb-example/thirdweb-auth-next-auth"
	description="A working example of Auth + Next Auth"
/>
...
The `domain` is used to prevent phishing attacks when your users login with their wallets - you can learn more about this in the [how auth works documentation](/connect/auth/how-it-works/siwe#domain).
