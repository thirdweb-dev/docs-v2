import { DocImage, OpenSourceCard, createMetadata, V4Callout } from "@doc";
import firebaseUsersImage from "../../assets/firebase-users.png";
import firebaseDBImage from "../../assets/firebase-db.png";
...
export const metadata = createMetadata({
	...
	title: "Firebase | thirdweb",
	description:
		"How to integrate Auth as a custom authentication provider for Firebase and automatically create a document in the user's Firestore collection when a user signs up successfully",
});
...
<OpenSourceCard
	title="firebase-auth"
	href="https://github.com/thirdweb-example/firebase-auth"
	description="A working example of Auth + Firebase"
/>
...
2. Once the payload is verified, creating a [custom token](https://firebase.google.com/docs/auth/admin/create-custom-tokens#create_custom_tokens_using_the_firebase_admin_sdk)
   for the user to sign in to Firebase.
