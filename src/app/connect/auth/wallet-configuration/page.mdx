import { Callout, createMetadata, V4Callout } from "@doc";
...
Auth only requires the following simple wallet interface to facilitate the signing and verification of JWTs:
