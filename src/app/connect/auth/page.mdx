...
<OpenSourceCard
	title="Auth"
	href="https://github.com/thirdweb-dev/js/tree/main/legacy_packages/auth"
/>
...
Auth integrates with a variety of server-side and client-side development frameworks. We&apos;re always adding support for more frameworks, so if you don&apos;t see yours, [let us know](https://thirdweb.com/contact-us), and we can explore adding support!
