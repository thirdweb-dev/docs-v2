...
Ecosystem Wallets start at $250/mo per instance. Instances allow for up to 30,000 active in-app wallets per month and $0.02 per additional active in-app wallet.
