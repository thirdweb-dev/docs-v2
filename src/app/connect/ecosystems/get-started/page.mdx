...
Visit the [Ecosystem Wallets dashboard](https://thirdweb.com/dashboard) and enter the name of your ecosystem and choose your logo.
...
Wallet signing settings default to signless interactions, meaning developers can sign on behalf of their end users. This is in line with typical in-app wallet functionality.
