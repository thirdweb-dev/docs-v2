...
By default, Account abstraction services services are enabled upon creation of the API Key. To set additional rules on which transactions you want to sponsor, head to the configuration tab in your [account abstraction dashboard](https://thirdweb.com/dashboard/connect/account-abstraction)

#### Embedded Wallets

By default, Embedded Wallet services are enabled upon creation of the API Key. You can view your embedded wallet's settings in the configuration tab of the [embedded wallet dashboard](https://thirdweb.com/dashboard/connect/embedded-wallets)
