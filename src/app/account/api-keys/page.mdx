...
API Keys are required to use thirdweb's infrastructure services including [Storage](/infrastructure/storage/overview), [RPC Edge](/infrastructure/rpc-edge/overview), [Smart Wallets](/connect/smart-wallet), and [Embedded Wallets](/connect/embedded-wallet/overview).
