...
#### thirdweb Credits 
These credits can be applied across any thirdweb service on any chain. This includes usage across Embedded Wallets, RPC, and IPFS storage.
...
You can view how many credits you have on the dashboard's [billing page](https://thirdweb.com/dashboard/settings/billing) or at the top of your thirdweb dashboard.

Both forms of credit will automatically be applied to your bill at the end of the month.
