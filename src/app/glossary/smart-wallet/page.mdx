...
can be used during the call execution via `EntryPoint`. The thirdweb [Smart Wallet](/connect/smart-wallet) paymaster is initially paid for by thirdweb. By using an API key,
