...
<Image
	className="mb-4"
	src={require("../../assets/auth-api-0.svg")}
	alt="auth-api-0"
/>
...
<Image
	className="mb-4"
	src={require("../../assets/auth-api-1.svg")}
	alt="auth-api-1"
/>
...
1. Check that the sign-in with wallet request is valid, secure, and hasn't expired, as specified in the [sign-in with wallet section](/wallets/auth/hoa-it-works/siwe).
2. Generate a signed JWT for the user to authenticate to other endpoints, as specified in the [JWT section](/wallets/auth/hoa-it-works/json-web-tokens).
...
<Image
	className="mb-4"
	src={require("../../assets/auth-api-2.svg")}
	alt="auth-api-2"
/>
...
1. Check that the user has sent a valid JWT in the request cookies or headers, as specified in the [JWT section](/wallets/auth/hoa-it-works/json-web-tokens).
...
<Image
	className="mb-4"
	src={require("../../assets/auth-api-3.svg")}
	alt="auth-api-3"
/>
...
<Image
	className="mb-4"
	src={require("../../assets/auth-api-4.svg")}
	alt="auth-api-4"
/>
