...
<DocImage
	src={require("../assets/web2auth-diagram.svg")}
	alt="web2-auth-diagram"
/>
...
<DocImage
	src={require("../assets/web3auth-diagram.svg")}
	alt="web3-auth-diagram"
/>
...
<DocImage src={require("../assets/auth-diagram.svg")} alt="auth-diagram" />
