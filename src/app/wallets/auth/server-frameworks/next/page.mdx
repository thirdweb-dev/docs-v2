...
To learn more about how to implement Auth on the client-side with Next.js (which you will likely need after implementing the server-side), see the Auth [React page](/wallets/auth/client-frameworks/react/latest) as Next uses React for the frontend:
