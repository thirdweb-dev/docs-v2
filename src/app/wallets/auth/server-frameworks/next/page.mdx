...
This page will focus mainly on integrating Auth on the server-side with [Next.js](https://nextjs.org) by implementing the [Auth API](/auth/how-it-works/auth-api).
