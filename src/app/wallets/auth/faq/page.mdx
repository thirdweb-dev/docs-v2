...
Learn how to change the token validity duration for both [Next](/wallets/auth/server-frameworks/next#changing-the-token-validity-duration) and [Express](/auth/server-frameworks/express#changing-the-token-validity-duration) in our documentation.
