...
Auth makes use of a server-side wallet to sign and verify JWTs, as covered in the [how auth works section](/wallets/auth/how-it-works/jwt). You can configure this wallet using a variety of wallet management options, giving you the freedom to choose the most convenient and secure setup for your project.
...
For more information on the available wallets and the specific of their setup, see the [`@thirdweb-dev/wallets` documentation](/references/wallets)
