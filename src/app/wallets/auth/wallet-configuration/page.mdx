...
Auth makes use of a server-side wallet to sign and verify JWTs, as covered in the [how auth works section](/wallets/auth/hoa-it-works/json-web-tokens). You can configure this wallet using a variety of wallet management options, giving you the freedom to choose the most convenient and secure setup for your project.
