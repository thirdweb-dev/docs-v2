...
The `domain` is used to prevent phishing attacks when your users login with their wallets - you can learn more about this in the [how auth works documentation](/auth/hoa-it-works/siwe#domain).
