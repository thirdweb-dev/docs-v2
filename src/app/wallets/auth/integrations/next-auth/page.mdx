...
The `domain` is used to prevent phishing attacks when your users login with their wallets - you can learn more about this in the [how auth works documentation](/wallets/auth/how-it-works/siwe#domain).
