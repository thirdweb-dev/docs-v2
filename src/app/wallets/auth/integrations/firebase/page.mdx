...
<OpenSourceCard
	repoName="firebase-auth"
	repoUrl="https://github.com/thirdweb-example/firebase-auth"
...
The `NEXT_PUBLIC_THIRDWEB_AUTH_DOMAIN` is used to prevent phishing attacks - and is usually set to the domain of your project like `example.com`. You can read more about it in the [thirdweb Auth Documentation](https://portal.thirdweb.com/auth/hoa-it-works/siwe#domain).
...
<Image
	className="mb-4"
	src={require("../../assets/firebase-users.png")}
	alt="firebase users"
/>
...
<Image
	className="mb-4"
	src={require("../../assets/firebase-db.png")}
	alt="firebase db"
/>
