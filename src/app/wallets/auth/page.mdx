import { CardLink, OpenSourceCard, ArticleIconCard, InstallTabs } from "@doc";
...
<ArticleIconCard
	title="Express"
	href="/wallets/auth/server-frameworks/express"
...
<ArticleIconCard
	title="React Native"
	href="/wallets/auth/client-frameworks/react-native"
...
<div className="flex flex-col gap-4">
	<ArticleIconCard
		title="Next Auth"
		href="/wallets/auth/integrations/next-auth"
	...
	<ArticleIconCard
		title="Firebase"
		href="/wallets/auth/integrations/firebase"
