...
<CardLink label="Getting Started" href="/auth/getting-started" icon="educate" />
<CardLink label="How Auth Works" href="/auth/getting-started" icon="educate" />
...
<ArticleIconCard
	title="Next.js"
	href="/auth/server-frameworks/next"
