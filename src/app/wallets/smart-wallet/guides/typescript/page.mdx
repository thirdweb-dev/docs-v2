...
By using the [wallet SDK](/references/wallets) alongside the [TypeScript SDK](/typescript/latest), you can use smart wallets in your applications easily.
...
If you are working in a React environment, you are recommended to follow [this guide](/wallets/smart-wallet/guides/react/latest).
