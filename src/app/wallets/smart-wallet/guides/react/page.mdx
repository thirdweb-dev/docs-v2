...
By using the [wallet SDK](/references/wallets) alongside the [React SDK](/react/latest), you can use smart wallets in your front-end applications easily.

<Steps>

<Step title="Deploy an Account Factory">

Deployable via the [explore page](https://thirdweb.com/explore/smart-wallet) or build your own [ERC 4337](https://eips.ethereum.org/EIPS/eip-4337) compatible factory contract using the [Solidity SDK](/contracts/build).
...
Deploy a NFT Drop contract from the [explore page](https://thirdweb.com/explore/nft-drop) or build your own [ERC 721](https://eips.ethereum.org/EIPS/eip-721) compatible contract using the [Solidity SDK](/contracts/build).
