...
You can easily set sponsorship rules by going to the [configuration tab in the Smart Wallet dashboard.](https://thirdweb.com/dashboard/wallets/smart-wallet?tab=1).To use them in your app all you need to do is pass your API key, sponsorship rules will automatically be applied.
