...
export const metadata = createMetadata({
	...
	description: "Frequently asked questions about thirdweb's Embedded Wallet",
	image: {
		title: "FAQs for Embedded Wallet",
		icon: "wallets",
	},
...
Yes, we show the email by default in the details modal after you connect. To display the email anywhere else using React or React Native, [check out the code snippets for all platforms](/wallets/embedded-wallet/how-to/interact-with-wallets#get-the-user-email).
