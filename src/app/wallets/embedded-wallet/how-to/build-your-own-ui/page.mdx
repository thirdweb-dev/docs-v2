...
import EmbeddedWallet from "../../images/embedded-wallet.svg";
...
<Callout variant='info' title="Embedded Wallets with Custom UI - React">

<div className="flex flex-row items-center gap-x-2">
	<Image src={EmbeddedWallet} />
	[Embedded Wallets with Custom UI - React](https://github.com/thirdweb-example/embedded-wallet-custom-ui)
</div>
...
<Callout variant='info' title="Embedded Wallets with Custom UI - React Native">

<div className="flex flex-row items-center gap-x-2">
	<Image src={EmbeddedWallet} />
	[Embedded Wallets with Custom UI - React Native](https://github.com/thirdweb-example/embedded-wallet-custom-ui-react-native)
</div>
