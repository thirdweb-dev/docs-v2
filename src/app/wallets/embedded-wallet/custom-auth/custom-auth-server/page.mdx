...
<Step title="Step 1">
	Navigate to Wallets > [Embedded
	Wallets](https://thirdweb.com/dashboard/wallets/embedded) in the thirdweb
	dashboard.
</Step>
...
<Step title="Step 2">
	...
	keys.](https://portal.thirdweb.com/api-keys)
