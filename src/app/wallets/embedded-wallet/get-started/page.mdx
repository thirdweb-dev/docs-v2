...
<Callout variant='info' title="CatAttackDemo">

<div className="flex flex-row items-center gap-x-2">
	<Image src={EmbeddedWallet} />
	[CatAttack: Embedded Wallet Demo App](https://catattack.thirdweb.com)
</div>
...
<Callout variant='info' title="Embedded + Smart Wallet Starter Kit">

<div className="flex flex-row items-center gap-x-2">
	<Image src={EmbeddedWallet} />
	[Embedded + Smart Wallet Starter Kit](https://github.com/thirdweb-example/embedded-smart-wallet)
</div>
