...
import { DocImage, Callout, DocLink } from "@doc";
...
HackerOne has audited embedded Wallet private key security architecture, and there is an ongoing bounty program to ensure vulnerabilities are caught. <DocLink children="View the Letter of Attestation." href="/pdfs/thirdweb_code_security_audit.pdf" isExternal />
