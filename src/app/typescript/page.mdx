...
It also simplifies interacting with standard contracts using the [Extensions Framework](/typescript/extensions). Standards and common contract patterns are detected by the SDK and unlocks a convenient, high level API which does the heavy lifting for you.
