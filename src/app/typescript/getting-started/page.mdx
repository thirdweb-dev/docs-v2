...
The SDK can be instantiated as read only or read/write.
...
This can be used for reading and writing data to the blockchain and requires a valid signer.

Can be instantiated from:

- A wallet instance from the Wallet SDK - [`ThirdwebSDK.fromWallet()`](/references/typescript/ThirdwebSDK#fromWallet) (recommended)
- A private key - [`ThirdwebSDK.fromPrivateKey()`](/references/typescript/ThirdwebSDK#fromPrivateKey)
- A ethers.js Signer instance - [`ThirdwebSDK.fromSigner()`](/references/typescript/ThirdwebSDK#fromSigner)
