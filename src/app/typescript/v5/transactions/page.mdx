...
```ts
import { prepareContractCall, parseEther } from "thirdweb";
...
```ts
import { getContract, prepareContractCall, parseEther } from "thirdweb";
...
```ts
import { prepareContractCall, resolveMethod, parseEther } from "thirdweb";
const tx = prepareContractCall({
	contract,
