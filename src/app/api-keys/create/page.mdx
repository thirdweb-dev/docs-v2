import { DocImage, Callout, Steps, Step } from "@/components/Document";
import createKeyImage from "../create-key.png";
import credentialsImage from "../credentials.png";
import descriptiveNameImage from "../descriptive-name.png";
