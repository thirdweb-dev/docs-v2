...
export function ContextAIBotButton() {
	...
	return (
		<div context-launcher="true" context-bot-id={contextBotId}>
			<Button
				onClick={handleClick}
				className="rounded-lg border border-accent-500 bg-accent-900 px-3 py-2.5 text-sm font-semibold hover:bg-accent-700 hover:text-f-100 lg:border-border lg:bg-b-700 lg:hover:bg-b-700"
				variant="outline"
			>
				<StarsIcon />
				ASK AI
